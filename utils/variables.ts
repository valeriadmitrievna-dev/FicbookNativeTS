...
export const ratings_data = [
  ...
  {
    value: 'PG-13',
    description: 'фанфики, в которых могут быть описаны романтические отношения на уровне поцелуев и/или могут присутствовать намёки на насилие и другие тяжёлые моменты.'
  },
  {
    value: 'R',
    description: 'фанфики, в которых присутствуют эротические сцены или насилие без детального графического описания.'
  },
  {
    value: 'NC-17',
    description: 'фанфики, в которых могут быть детально описаны эротические сцены, насилие либо какие-то другие тяжёлые моменты.'
  },
  {
    value: 'NC-21',
    description: 'фанфики, в которых может быть очень высок уровень жестокости, насилия, подробного описания эротических сцен или чего-либо подобного.'
  },
]
...
export const directions_data = [
  {
    value: 'gen',
    description: 'не описываются и не упоминаются сексуальные взаимоотношения или они не играют решающей роли.'
  },
  {
    value: 'het',
    description: 'романтические и/или сексуальные отношения между мужчиной и женщиной.'
  },
  {
    value: 'femslash',
    description: 'романтические и/или сексуальные взаимоотношения между женщинами.'
  },
  {
    value: 'slash',
    description: 'романтические и/или сексуальные взаимоотношения между мужчинами.'
  },
  {
    value: 'mixed',
    description: 'несколько равнозначных романтических линий (гет, слэш, фемслэш).'
  },
  {
    value: 'other',
    description: 'романтические и/или сексуальные отношения, которые нельзя охарактеризовать ни как слэш, ни как фемслэш, ни как гет ни в одном проявлении.'
  },
  {
    value: 'article',
    description: 'Публицистический текст о фэндоме или писательском искусстве, строящийся по форме «тезис, аргументы в его пользу, вывод»'
  },
]